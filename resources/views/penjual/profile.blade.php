...
<form action="{{url('penjualprofile/'.Auth::user()->id.'/'.Auth::user()->name)}}" method="post">
  @csrf
<div class="mb-3">
...
<div class="mb-3">
  ...
  <input type="nomorhp" class="form-control" id="nomorhp"name="nomorhp" value="{{$value->nomorhp}}">
</div>
<div class="mb-3">

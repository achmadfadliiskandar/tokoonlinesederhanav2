...
@endif
<a href="{{url('adminaddbarang')}}" class="btn btn-primary my-3">Tambah Barang</a>
<div class="container">
...
<tr>
   ...
   <td>
    <a href="{{url('adminshowbarang',$barang->slug)}}" class="btn btn-info">Detail</a>
    <a href="{{url('admineditbarang',$barang->slug)}}" class="btn btn-success">Edit</a>
    <form action="{{url('admindeletebarang',$barang->id)}}" method="post" onsubmit="return confirm('yakin mau dihapus')">
      @csrf
      @method("DELETE")
